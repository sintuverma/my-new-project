 ...
 <body>
  <div class="navbar navbar-inverse  navbar-custom">
      <div class="container">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav navbar-right">
                 ...
                 <li><a href="<?php echo base_url()?>Upload_multiple_studio_pictures/photoStudio_profile"><span class="glyphicon glyphicon-home"></span> Home</a></li>
    ...
    <ul class="dropdown-menu">
      ...
      <li><?=  anchor("Update_controller/edit_photostudio_profile_data/{$data->user_id}",'Edit Your Profile',['class'=>'btn text-primary btn-info glyphicon glyphicon-pencil edit ','style'=>'color:black;']);  ?></li>
      <li class="divider"></li>
      <li><?=  anchor("Update_controller/edit_reg_account_photostudio/{$data->user_id}",'Edit Your Account',['class'=>'btn btn-info glyphicon glyphicon-pencil edit  ','style'=>'color:black;']);  ?></li>
      <li class="divider"></li>
      <li><?=  anchor("Update_controller/edit_photostudio_images/{$data->user_id}",'Edit Your Images',['class'=>'btn btn-info glyphicon glyphicon-pencil edit ','style'=>'color:black;']);  ?></li>
      <li class="divider"></li>
      <li><?=  anchor("Update_Password_controller/update_photostudio_password",'Change Password',['class'=>'btn text-primary btn-info glyphicon glyphicon-pencil edit ','style'=>'color:black;']);  ?></li>
      <li class="divider"></li>
      <li>
