...
<?php endif; ?>
  ...
  {
    $image_id=$profile->catering_image_id;
  $image_arr = explode(",", $profile->catering_pictures);

            foreach($image_arr as $image_name)
            {
              $data=base_url().'cateringPictures/'.$image_name;
...
<script type="text/javascript">
    ...
    function del(id,imagename){
       var r=confirm("Do you want to delete this?");
        if (r==true)
          window.location = url+"Update_images_controller/delete_catering_pictures/"+id;
        else
          return false;
        } 
</script>
