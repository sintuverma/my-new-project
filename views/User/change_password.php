  			...
  			<div class="col-sm-offset-3 col-sm-6">
  				...
  				<div class="tab-content">
  					...
  					<?php $attributes = array('id' =>'UpdationForm');
  					 echo form_open('Update_Password_controller/updatePwd',$attributes);?>
			      ...
			      <div class="form-group">
					...
					<?php echo form_password(['name'=>'password','class'=>'form-control','id'=>'inputPassword','required'=>'required','data-parsley-length'=>'[8, 20]','placeholder'=>'Old Password']);?>
			      ...
			      <div class="form-group">
					...
					<?php echo form_password(['name'=>'newpass','class'=>'form-control','id'=>'inputPassword2','required'=>'required','data-parsley-length'=>'[8, 20]','placeholder'=>'New Password']);?>
			      ...
			      <div class="form-group">
					...
					<?php echo form_password(['name'=>'confpassword','class'=>'form-control','id'=>'inputPassword3','required'=>'required','data-parsley-equalto'=>'#inputPassword2','placeholder'=>'Password Confirmation']);?>
