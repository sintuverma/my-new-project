...
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.8.0/css/bootstrap-datepicker.css" rel="stylesheet"/>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/css/sign-up.css"> 
 ...
 <body>
  <div class="navbar navbar-inverse  navbar-custom">
      <div class="container">
         ...
         <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav navbar-right">
                 ...
                 <li><a href="<?php echo base_url()?>Upload_multiple_guesthouse_images/profile"><span class="glyphicon glyphicon-home"></span> Home</a></li>
    ...
    <ul class="dropdown-menu">
      ...
      <li><?=  anchor("Update_controller/edit_guest_house_data/{$data->user_id}",'Edit Your Profile',['class'=>'btn text-primary btn-info glyphicon glyphicon-pencil edit ','style'=>'color:black;']);  ?></li>
      <li class="divider"></li>
      <li><?=  anchor("Update_controller/edit_reg_account/{$data->user_id}",'Edit Your Account',['class'=>'btn btn-info glyphicon glyphicon-pencil edit  ','style'=>'color:black;']);  ?></li>
      <li class="divider"></li>
      <li><?=  anchor("Update_controller/edit_images_data/{$data->user_id}",'Edit Your Images',['class'=>'btn btn-info glyphicon glyphicon-pencil edit ','style'=>'color:black;']);  ?></li>
      <li class="divider"></li>
      <li><?=  anchor("Update_Password_controller/",'Change Password',['class'=>'btn text-primary btn-info glyphicon glyphicon-pencil edit ','style'=>'color:black;']);  ?></li>
      <li class="divider"></li>
      <li>
